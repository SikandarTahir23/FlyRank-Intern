...
/**
 * Submission schemas for validation and type safety.
 */
export const submissionPayloadSchema = z.record(z.string(), z.any());

export const createSubmissionSchema = z.object({
  // Payload is flexible but we validate honeypot presence in middleware
  // Additional fields validated by widget config
...
export const listSubmissionsQuerySchema = z.object({
  ...
  is_spam: z.coerce.boolean().optional(),

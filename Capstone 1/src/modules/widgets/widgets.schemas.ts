...
/**
 * Widget schemas for validation and type safety.
 */
...
export const widgetSchema = z.object({
  ...
  type: z.enum(['lead-form', 'contact', 'newsletter', 'custom']),
  config_json: widgetConfigSchema,
  is_active: z.boolean(),
  created_at: z.date(),
});
...
export const createWidgetSchema = z.object({
  name: z.string().min(1).max(255),
  type: z.enum(['lead-form', 'contact', 'newsletter', 'custom']).default('lead-form'),
  config_json: widgetConfigSchema,

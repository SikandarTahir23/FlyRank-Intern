...
// Kept identical to the original in-memory version; only the description
// wording reflects the new storage backend.
...
router.get("/", (request, response) => {
  response.json({
    ...
    version: "1.0.0",
    description: "A simple to-do list REST API backed by SQLite storage",
    documentation: "/docs",
  });
});
